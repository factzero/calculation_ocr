...
if __name__ == '__main__':
    ...
    for res in det_recs:
        ...
        cv2.line(image, (int(res[0]), int(res[1])), (int(res[2]), int(res[3])), (0, 0, 255), 2)
        cv2.line(image, (int(res[0]), int(res[1])), (int(res[4]), int(res[5])), (0, 0, 255), 2)
        cv2.line(image, (int(res[6]), int(res[7])), (int(res[2]), int(res[3])), (0, 0, 255), 2)
        cv2.line(image, (int(res[4]), int(res[5])), (int(res[6]), int(res[7])), (0, 0, 255), 2)
